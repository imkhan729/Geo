...
export default function Home() {
  ...
  const faqs = [
    ...
    { q: "What file formats are supported?", a: "JPG, PNG, WebP, and HEIC are all supported. Note that HEIC files are automatically converted to high-quality JPEG to support standard GPS metadata, while JPG, PNG, and WebP files natively retain their format." },
        ...
        <div className="container mx-auto px-4 text-center max-w-6xl">
          ...
          >
            <CardContent className="py-14">
              ...
              <p className="text-xs text-muted-foreground mt-2">* HEIC files are converted to JPEG to ensure Exif compatibility. JPG, PNG, and WebP natively retain their format.</p>
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            <div className="card-3d h-full">
              <Card className="card-3d-inner text-center p-6 h-full bg-gradient-to-br from-purple-500/10 to-transparent border-purple-500/20">
                ...
                <p className="text-sm text-muted-foreground">JPG, PNG, WebP natively. HEIC is auto-converted.</p>
              </Card>
            </div>
          </div>
        </div>
