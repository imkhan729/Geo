          ...
          <div className="mt-10 p-6 rounded-2xl bg-primary/5 border border-primary/20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <EclipseButton
                ...
                onClick={() => {
                trackArticleToToolClick({ article_slug: "how-to-geotag-photos-android", destination: "home" });
                navigate("/");
              }}
              />
              <EclipseButton
                ...
                variant="outline"
                onClick={() => {
                trackArticleToToolClick({ article_slug: "how-to-geotag-photos-android", destination: "gps_finder" });
                navigate("/gps-finder");
              }}
              />
            </div>
