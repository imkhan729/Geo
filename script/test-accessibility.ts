...
async function runAllTests() {
  ...
  await runTest("All 21 site routes include <main id=\"main-content\" tabIndex={-1}> landmark", () => {
    assert.ok(pageFiles.length >= 21, `Expected at least 21 pages, found ${pageFiles.length}`);
