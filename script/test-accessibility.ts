...
async function runAllTests() {
  ...
  await runTest("All 18 site routes include <main id=\"main-content\" tabIndex={-1}> landmark", () => {
    assert.ok(pageFiles.length >= 17, `Expected at least 17 pages, found ${pageFiles.length}`);
