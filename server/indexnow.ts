...
export function mapChangedFilesToUrls(filePaths: string[], host = INDEXNOW_HOST): string[] {
  ...
  const fileMap: Record<string, string> = {
    ...
    "client/src/pages/remove-gps-from-photo.tsx": "/remove-gps-from-photo",
    "client/src/pages/coordinate-converter.tsx": "/coordinate-converter",
    "client/src/pages/batch-geotag-photos.tsx": "/batch-geotag-photos",
